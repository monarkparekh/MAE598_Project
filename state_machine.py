...
class ColumnScan_A_star(State):
    ...
    def check_transition(self, agent, state_machine):
        ...
        if self.waypoints_generated == False:
            ...
            waypoints.append(vec2(initial_c + RESOLUTION    , SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + RESOLUTION    , initial_r))
            waypoints.append(vec2(initial_c + 2* RESOLUTION , initial_r))

            waypoints.append(vec2(initial_c + 2* RESOLUTION, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 3* RESOLUTION, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 3* RESOLUTION, initial_r))
            waypoints.append(vec2(initial_c + 4* RESOLUTION, initial_r))

            waypoints.append(vec2(initial_c + 4 * RESOLUTION, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 5 * RESOLUTION, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 5 * RESOLUTION, initial_r))
            waypoints.append(vec2(initial_c + 6 * RESOLUTION, initial_r))

            waypoints.append(vec2(initial_c + 6 * RESOLUTION, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 7 * RESOLUTION, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 7 * RESOLUTION, initial_r))
            waypoints.append(vec2(initial_c + 8 * RESOLUTION, initial_r))

            waypoints.append(vec2(initial_c + 8 * RESOLUTION, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 9 * RESOLUTION, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 9 * RESOLUTION, initial_r))
            waypoints.append(vec2(initial_c + 10 * RESOLUTION, initial_r))
...
class ColumnScan_small_Astar(State):
    ...
    def check_transition(self, agent, state_machine):
        ...
        if self.waypoints_generated == False:
            ...
            waypoints.append(vec2(initial_c, initial_r))
            waypoints.append(vec2(initial_c, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + RESOLUTION*num_swarm, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + RESOLUTION*num_swarm, initial_r))
            waypoints.append(vec2(initial_c + 2 * RESOLUTION*num_swarm, initial_r))

            waypoints.append(vec2(initial_c + 2 * RESOLUTION*num_swarm, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 3 * RESOLUTION*num_swarm, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 3 * RESOLUTION*num_swarm, initial_r))
            waypoints.append(vec2(initial_c + 4 * RESOLUTION*num_swarm, initial_r))

            waypoints.append(vec2(initial_c + 4 * RESOLUTION*num_swarm, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 5 * RESOLUTION*num_swarm, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 5 * RESOLUTION*num_swarm, initial_r))
            waypoints.append(vec2(initial_c + 6 * RESOLUTION*num_swarm, initial_r))

            waypoints.append(vec2(initial_c + 6 * RESOLUTION*num_swarm, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 7 * RESOLUTION*num_swarm, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 7 * RESOLUTION*num_swarm, initial_r))
            waypoints.append(vec2(initial_c + 8 * RESOLUTION*num_swarm, initial_r))

            waypoints.append(vec2(initial_c + 8 * RESOLUTION*num_swarm, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 9 * RESOLUTION*num_swarm, SCREEN_HEIGHT - initial_r))
            waypoints.append(vec2(initial_c + 9 * RESOLUTION*num_swarm, initial_r))
            waypoints.append(vec2(initial_c + 10 * RESOLUTION*num_swarm, initial_r))
